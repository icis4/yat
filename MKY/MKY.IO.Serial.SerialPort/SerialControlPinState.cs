...
namespace MKY.IO.Serial.SerialPort
{
	...
	public class SerialControlPinStateEx : EnumEx
	{
		...
		public static SerialControlPinStateEx[] GetItems()
		{
			...
			{
				new SerialControlPinStateEx(SerialControlPinState.Automatic),
				new SerialControlPinStateEx(SerialControlPinState.Disabled),
				new SerialControlPinStateEx(SerialControlPinState.Enabled)
			};
			return (a.ToArray());
		}
