...
{
	/// <summary></summary>
	public class ReferenceTypeIEquatableWithBaseOperators_Base : IEquatable<ReferenceTypeIEquatableWithBaseOperators_Base>
	{
		/// <summary></summary>
		...
		/// <summary></summary>
		public ReferenceTypeIEquatableWithBaseOperators_Base(int b)
		{
			B = b;
		}
		...
		{
			return (Equals(obj as ReferenceTypeIEquatableWithBaseOperators_Base));
		}
		...
		/// properties, i.e. properties with some logic, are also properly handled.
		/// </remarks>
		public bool Equals(ReferenceTypeIEquatableWithBaseOperators_Base other)
		{
		...
		/// </summary>
		public static bool operator ==(ReferenceTypeIEquatableWithBaseOperators_Base lhs, ReferenceTypeIEquatableWithBaseOperators_Base rhs)
		{
			if (Configuration.TraceCallingSequence) // Trace the calling sequence:
			{
				Trace.Indent();
