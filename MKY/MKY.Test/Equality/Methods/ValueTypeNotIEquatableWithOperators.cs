...
namespace MKY.Test.Equality.Methods
{
	internal static class ValueTypeNotIEquatableWithOperators
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ValueTypeNotIEquatableWithOperators objToCompareAgainst, Types.ValueTypeNotIEquatableWithOperators objEqual, Types.ValueTypeNotIEquatableWithOperators objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ValueTypeNotIEquatableWithOperators objToCompareAgainst, Types.ValueTypeNotIEquatableWithOperators objEqual, Types.ValueTypeNotIEquatableWithOperators objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
