...
namespace YAT.Settings.Terminal
{
	...
	public class TerminalSettingsRoot : MKY.Settings.SettingsItem, IEquatable<TerminalSettingsRoot>, MKY.Xml.IAlternateXmlElementProvider
	{
		...
		/*	new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "IO"                                     }, new string[] { "SerialPort", "OutputBreakIsModifiable" }, new string[] { "SerialPortOutputBreakIsModifiable" } ),      => Should be moved, but doesn't work because new name is at a deeper level. Should be solved using XML transformation. */
			...
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "IO", "SerialPort", "Communication"      }, "RtsPin",                                                 new string[] { "RfrPin" } ),
			...
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "IO", "SerialPort"                       }, "BufferMaxBaudRate",                                      new string[] { "OutputMaxBaudRate" } ),
		...
		/*	new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "TextTerminal"                           }, "TextExclusion",                                          new string[] { "EolComment" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "TextTerminal", "TextExclusion"          }, "Enabled",                                                new string[] { "SkipComment" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "TextTerminal", "TextExclusion"          }, "Patterns",                                               new string[] { "Indicators" } ),                          => Should be renamed, but doesn't work because two levels got renamed at once. Should be solved using XML transformation. */
			...
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Display"                                }, "ShowLineNumbers",                                        new string[] { "ShowTotalLineNumbers" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Display"                                }, "ShowTimeStamp",                                          new string[] { "ShowTime" } ),
			...
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Display"                                }, "MaxLineLength",                                          new string[] { "MaxBytePerLineCount" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Send"                                   }, "KeepSendText",                                           new string[] { "KeepCommand" } ),
		/*	new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Send"                                   }, new string[] { "Text", "KeepSendText",                    new string[] { "KeepCommand" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Send"                                   }, new string[] { "Text", "CopyPredefined",                  new string[] { "CopyPredefined" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Send"                                   }, new string[] { "Text", "SendImmediately",                 new string[] { "SendImmediately" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal", "Send"                                   }, new string[] { "Text", "EnableEscapes",                   new string[] { "EnableEscapes" } ),                          => Should be moved, but doesn't work because new name is at a deeper level. Should be solved using XML transformation. */
		...
		/*	new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Terminal"                                           }, new string[] { "Send", "File", "SkipEmptyLines"           new string[] { "TextTerminal", "SendFile", "SkipEmptyLines" ), => Should be move, but doesn't work because it got moved over two levels. Should be solved using XML transformation. */
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Format"                                             }, "TimeStampFormat",                                        new string[] { "TimeFormat" } ),
		/*	new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "PredefinedCommand", "Pages", "Commands"             }, "TextLines",                                              new string[] { "CommandLines" } ),                   => Should be renamed, but doesn't work because it is part of a serializable object. Should be solved using XML transformation. */
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Log"                                                }, "NameType",                                               new string[] { "NameFormat" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Log"                                                }, "NameDirection",                                          new string[] { "NameChannel" } ),
			...
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Log"                                                }, "FolderType",                                             new string[] { "FolderFormat" } ),
			new MKY.Xml.AlternateXmlElement(new string[] { "#document", "Settings", "Explicit", "Log"                                                }, "FolderDirection",                                        new string[] { "FolderChannel" } ),
