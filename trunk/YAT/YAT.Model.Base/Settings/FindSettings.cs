...
namespace YAT.Model.Settings
{
	...
	public class FindSettings : MKY.Settings.SettingsItem, IEquatable<FindSettings>
	{
		...
		/// <summary></summary>
		[XmlElement("AllIsActive")]
		public virtual bool AllIsActive
		{
			get { return (this.allIsActive); }
			set
			{
				if (this.allIsActive != value)
				{
					this.allIsActive = value;
					SetMyChanged();
				}
			}
		}
		...
		public override int GetHashCode()
		{
			unchecked
			{
				...
				hashCode = (hashCode * 397) ^ AllIsActive.GetHashCode();
		...
		public bool Equals(FindSettings other)
		{
			...
			(
				...
				AllIsActive.Equals(other.AllIsActive)
			);
		}
