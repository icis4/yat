...
namespace YAT.Model.Test
{
	...
	public class FileHandlingTest
	{
		...
		public virtual void TestAutoDeleteOnClose()
		{
			...
			using (main = new Main())
			{
				success = (main.Start() == Main.Result.Success);
		...
		public virtual void TestSequenceOfUseCases_6_through_9_()
		{
			            ...
			            main2 = new Main(this.normalTerminal2FilePath))
			{
				...
				// Main 1 start.
				{
					success = (main1.Start() == Main.Result.Success);
				...
				// Main 2 start.
				{
					success = (main2.Start() == Main.Result.Success);
				...
				// Main 1 exit.
				{
					success = (main1.Exit() == Main.Result.Success);
				...
				// Main 2 exit.
				{
					success = (main2.Exit() == Main.Result.Success);
		...
		public virtual void TestDeletedWorkspaceFile()
		{
			...
			using (Main main = new Main())
			{
				...
				success = (main.Start() == Main.Result.ApplicationStartError);
