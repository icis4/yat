...
namespace MKY.Net
{
	...
	/// </summary>
	[Serializable]
	public class RecentIPFilterCollection : RecentItemCollection<string>
	{
		/// <summary></summary>
		public RecentIPFilterCollection()
			: base()
		{
		}

		/// <summary></summary>
		public RecentIPFilterCollection(int capacity)
			: base(capacity)
		{
		}
		...
		public RecentIPFilterCollection(IEnumerable<RecentItem<string>> collection)
			: base(collection)
		{
		}
