...
namespace MKY.Windows.Forms
{
	...
	public static class ControlEx
	{
		...
		public static int TagToInt32(object sender)
		{
			...
			throw (new ArgumentException(MessageHelper.InvalidExecutionPreamble + "'" + sender + "' is no 'Control'!" + Environment.NewLine + Environment.NewLine + MessageHelper.SubmitBug, nameof(sender)));
		}
