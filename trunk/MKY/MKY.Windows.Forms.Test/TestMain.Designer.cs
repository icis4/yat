namespace MKY.Windows.Forms.Test
{
	partial class TestMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.button_TestMessageBoxes = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			...
			this.button_TextInputControls.Location = new System.Drawing.Point(12, 41);
			...
			this.button_TextInputControls.TabIndex = 1;
			this.button_TextInputControls.Text = "Test &TextInput Controls";
			...
			// 
			// button_TestMessageBoxes
			// 
			this.button_TestMessageBoxes.Location = new System.Drawing.Point(12, 12);
			this.button_TestMessageBoxes.Name = "button_TestMessageBoxes";
			this.button_TestMessageBoxes.Size = new System.Drawing.Size(260, 23);
			this.button_TestMessageBoxes.TabIndex = 0;
			this.button_TestMessageBoxes.Text = "Test &MesssageBoxes";
			this.button_TestMessageBoxes.UseVisualStyleBackColor = true;
			this.button_TestMessageBoxes.Click += new System.EventHandler(this.button_TestMessageBoxes_Click);
			// 
			// TestMain
			// 
			...
			this.Controls.Add(this.button_TestMessageBoxes);
		...
		private System.Windows.Forms.Button button_TestMessageBoxes;
	}
}