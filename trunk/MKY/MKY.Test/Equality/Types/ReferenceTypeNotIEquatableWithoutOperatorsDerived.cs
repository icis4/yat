...
{
	/// <summary></summary>
	public class ReferenceTypeNotIEquatableWithoutOperatorsDerived : ReferenceTypeNotIEquatableWithoutOperatorsBase
	{
		/// <summary></summary>
		...
		/// <summary></summary>
		public ReferenceTypeNotIEquatableWithoutOperatorsDerived(int b, int d)
			: base(b)
		{
			D = d;
		}
		...
		public override bool Equals(object obj)
		{
			if (Configuration.TraceCallingSequence) // Trace the calling sequence:
			{
				...
				var other = (obj as ReferenceTypeNotIEquatableWithoutOperatorsDerived);
