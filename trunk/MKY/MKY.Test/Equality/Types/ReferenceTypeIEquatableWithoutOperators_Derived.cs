...
{
	/// <summary></summary>
	public class ReferenceTypeIEquatableWithoutOperators_Derived : ReferenceTypeIEquatableWithoutOperators_Base, IEquatable<ReferenceTypeIEquatableWithoutOperators_Derived>
	{
		/// <summary></summary>
