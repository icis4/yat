...
{
	internal static class ReferenceTypeObject
	{
		...
		public static void TestOperatorsForReferenceEquality(object objToCompareAgainst, object objEqual, object objNotEqual)
		{
			Trace.Indent();
