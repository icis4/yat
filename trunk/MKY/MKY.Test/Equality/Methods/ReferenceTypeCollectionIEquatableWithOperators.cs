...
namespace MKY.Test.Equality.Methods
{
	internal static class ReferenceTypeCollectionIEquatableWithOperators
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeCollectionIEquatableWithOperators<int> objToCompareAgainst, Types.ReferenceTypeCollectionIEquatableWithOperators<int> objEqual, Types.ReferenceTypeCollectionIEquatableWithOperators<int> objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeCollectionIEquatableWithOperators<int> objToCompareAgainst, Types.ReferenceTypeCollectionIEquatableWithOperators<int> objEqual, Types.ReferenceTypeCollectionIEquatableWithOperators<int> objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
