...
{
	internal static class ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objToCompareAgainst, Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objEqual, Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objToCompareAgainst, Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objEqual, Types.ReferenceTypeIEquatableWithDerivedOperators_DerivedDerived objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
