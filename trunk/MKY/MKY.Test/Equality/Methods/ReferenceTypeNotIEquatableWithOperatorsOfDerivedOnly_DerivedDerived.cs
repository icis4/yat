...
{
	internal static class ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objEqual, Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objEqual, Types.ReferenceTypeNotIEquatableWithOperatorsOfDerivedOnly_DerivedDerived objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
