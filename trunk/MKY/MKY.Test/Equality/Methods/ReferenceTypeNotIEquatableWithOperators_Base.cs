...
namespace MKY.Test.Equality.Methods
{
	internal static class ReferenceTypeNotIEquatableWithOperators_Base
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeNotIEquatableWithOperators_Base objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperators_Base objEqual, Types.ReferenceTypeNotIEquatableWithOperators_Base objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeNotIEquatableWithOperators_Base objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperators_Base objEqual, Types.ReferenceTypeNotIEquatableWithOperators_Base objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
