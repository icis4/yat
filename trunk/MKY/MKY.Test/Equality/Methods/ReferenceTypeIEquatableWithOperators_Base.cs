...
namespace MKY.Test.Equality.Methods
{
	internal static class ReferenceTypeIEquatableWithOperators_Base
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeIEquatableWithOperators_Base objToEqualAgainst, Types.ReferenceTypeIEquatableWithOperators_Base objEqual, Types.ReferenceTypeIEquatableWithOperators_Base objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeIEquatableWithOperators_Base objToEqualAgainst, Types.ReferenceTypeIEquatableWithOperators_Base objEqual, Types.ReferenceTypeIEquatableWithOperators_Base objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
