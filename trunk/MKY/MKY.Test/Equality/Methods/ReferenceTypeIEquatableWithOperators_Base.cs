...
{
	internal static class ReferenceTypeIEquatableWithOperators_Base
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeIEquatableWithOperators_Base objToCompareAgainst, Types.ReferenceTypeIEquatableWithOperators_Base objEqual, Types.ReferenceTypeIEquatableWithOperators_Base objNotEqual)
		{
			Trace.Indent();
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeIEquatableWithOperators_Base objToCompareAgainst, Types.ReferenceTypeIEquatableWithOperators_Base objEqual, Types.ReferenceTypeIEquatableWithOperators_Base objNotEqual)
		{
			Trace.Indent();
			TraceEx.WriteLocation();
			Trace.Indent();
