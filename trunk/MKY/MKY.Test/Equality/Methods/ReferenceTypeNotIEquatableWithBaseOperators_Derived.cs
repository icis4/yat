...
{
	internal static class ReferenceTypeNotIEquatableWithBaseOperators_Derived
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objToCompareAgainst, Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objEqual, Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objNotEqual)
		{
			Trace.Indent();
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objToCompareAgainst, Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objEqual, Types.ReferenceTypeNotIEquatableWithBaseOperators_Derived objNotEqual)
		{
			Trace.Indent();
			TraceEx.WriteLocation();
			Trace.Indent();
