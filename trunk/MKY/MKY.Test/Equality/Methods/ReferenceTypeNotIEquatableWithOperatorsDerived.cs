...
{
	internal static class ReferenceTypeNotIEquatableWithOperatorsDerived
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeNotIEquatableWithOperatorsDerived objToCompareAgainst, Types.ReferenceTypeNotIEquatableWithOperatorsDerived objEqual, Types.ReferenceTypeNotIEquatableWithOperatorsDerived objNotEqual)
		{
			Trace.Indent();
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeNotIEquatableWithOperatorsDerived objToCompareAgainst, Types.ReferenceTypeNotIEquatableWithOperatorsDerived objEqual, Types.ReferenceTypeNotIEquatableWithOperatorsDerived objNotEqual)
		{
			Trace.Indent();
			TraceEx.WriteLocation();
			Trace.Indent();
