...
namespace MKY.Test.Equality.Methods
{
	internal static class ReferenceTypeNotIEquatableWithOperators_Derived
	{
		...
		public static void TestOperatorsForReferenceEquality(Types.ReferenceTypeNotIEquatableWithOperators_Derived objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperators_Derived objEqual, Types.ReferenceTypeNotIEquatableWithOperators_Derived objNotEqual)
		{
		...
		public static void TestOperatorsForValueEquality(Types.ReferenceTypeNotIEquatableWithOperators_Derived objToEqualAgainst, Types.ReferenceTypeNotIEquatableWithOperators_Derived objEqual, Types.ReferenceTypeNotIEquatableWithOperators_Derived objNotEqual)
		{
			if (Configuration.TraceCallingSequence) {
				Trace.Indent();
				TraceEx.WriteLocation();
