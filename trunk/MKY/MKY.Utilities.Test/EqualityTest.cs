...
namespace MKY.Utilities.Test
{
	...
	/// <summary></summary>
	[TestFixture, Explicit("This test fixture only displays the general functionality of Equals() and ==/!=. It does not test any MKY.Utilities functionality.")]
	...
	/// <summary></summary>
	[TestFixture, Explicit("This test fixture only tests the general functionality of Equals() and ==/!=. It does not test any MKY.Utilities functionality.")]
