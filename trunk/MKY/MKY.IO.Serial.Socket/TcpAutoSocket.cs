...
namespace MKY.IO.Serial.Socket
{
	...
	////}
		...
		protected virtual void OnIOControlChanged(EventArgs e)
		{
			...
			throw (new NotImplementedException("Program execution should never get here, the event 'IOControlChanged' is not in use for TCP AutoSockets." + Environment.NewLine + Environment.NewLine + MessageHelper.SubmitBug));
		}
