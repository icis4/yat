...
namespace YAT.Gui.Test
{
	...
	public class StressTest
	{
		...
		{
			string workspaceSettingsFilePath = XPath.MakeTempFilePath(this, System.Guid.NewGuid().ToString(), ExtensionSettings.WorkspaceFile);
			string terminalSettings1FilePath = XPath.MakeTempFilePath(this, System.Guid.NewGuid().ToString(), ExtensionSettings.TerminalFile);
			string terminalSettings2FilePath = XPath.MakeTempFilePath(this, System.Guid.NewGuid().ToString(), ExtensionSettings.TerminalFile);
			...
			string transmitFilePath = XPath.MakeTempFilePath(this, System.Guid.NewGuid().ToString(), ".txt");
