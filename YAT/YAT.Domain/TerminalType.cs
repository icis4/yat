	...
	public class TerminalTypeEx : EnumEx
	{
		...
		public override string ToString()
		{
			switch ((TerminalType)UnderlyingEnum)
			{
				...
				default: throw (new NotSupportedException(MessageHelper.InvalidExecutionPreamble + "'" + UnderlyingEnum.ToString() + "' is a terminal type that is not (yet) supported here!" + Environment.NewLine + Environment.NewLine + MessageHelper.SubmitBug));
			}
		}
