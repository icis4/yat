...
namespace YAT.Domain
{
	...
	public class IOTypeEx : EnumEx
	{
		...
		{
			List<IOTypeEx> a = new List<IOTypeEx>(8); // Preset the required capactiy to improve memory management.
		...
		public static IOTypeEx Parse(string s)
		{
			...
			if (TryParse(s, out result)) // TryParse() trims whitespace.
				...
				throw (new FormatException(@"""" + s + @""" is an invalid I/O type string! String must one of the underlying enumeration designations."));
		}
