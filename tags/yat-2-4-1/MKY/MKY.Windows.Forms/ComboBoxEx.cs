...
namespace MKY.Windows.Forms
{
	...
	public class ComboBoxEx : ComboBox, IOnFormDeactivateWorkaround
	{
		...
		protected override void OnGotFocus(EventArgs e)
		{
			...
			// Attention:
			// Same code exists in ToolStripComboBoxEx.OnGotFocus().
	...
	////}
		...
		protected override void OnLeave(EventArgs e)
		{
			...
			if (Focused)
			{
				...
				DebugCursorAndSelection(string.Format("...cursor position {0} and text selection length {1} implicitly remembered.", SelectionStart, SelectionLength));
			}
			else
			{
		...
		public virtual void OnFormDeactivateWorkaround()
		{
			...
			// Attention:
			// Same code exists in ToolStripComboBoxEx.OnFormDeactivateWorkaround().
			// Changes here will have to be applied there too.
